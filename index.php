...
<body>
    ...
    <header
        ...
        <a class="btn btn-outline-primary" href="https://www.facebook.com/anjali.sah">fb Chat</a>
    </header>
    <div class="masthead text-center text-white purple p-4">
        <div class="masthead-content">
            <div class="container">
                <h1 class="masthead-heading mb-0">Hello there !</h1>
                <h2 class="masthead-subheading mb-0">I am Anjali Sah</h2>
                <a href="https://github.com/anjalisaha" class="btn btn-primary btn-xl rounded-pill mt-5">My GitHub
                    Profile</a>
            </div>
        </div>
